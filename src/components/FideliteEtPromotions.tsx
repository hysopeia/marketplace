      ...
      <div style={cardStyle}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
          ...
          <button
            ...
            style={{
              ...
              background: config.actif ? "#EAF3DE" : "#F3F4F6",
              color: config.actif ? "#3B6D11" : "#6B7280", fontSize: 12, fontWeight: 600,
            }}
          >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
          ...
          <input
            ...
            style={{
              width: 90, padding: "8px 10px", border: "1px solid #E5E1D8",
        ...
        <input
          ...
          style={{
            width: "100%", padding: "9px 12px", border: "1px solid #E5E1D8",
        ...
        {messageSucces && (
          <p style={{ fontSize: 12, color: "#3B6D11", marginBottom: 10 }}>{t("fidelite_sauvegarde")}</p>
        )}
      ...
      <div style={cardStyle}>
        ...
        <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
          <input
            ...
            style={{
              flex: 1, padding: "9px 12px", border: "1px solid #E5E1D8",
              borderRadius: 8, fontSize: 13, boxSizing: "border-box",
            }}
          />
          <button
            ...
            style={{
              ...
              borderRadius: 8, border: "none", background: "#F59E0B", color: "white",
        ...
        {promotions.length === 0 ? (
          <p style={{ fontSize: 13, color: "#9CA3AF" }}>{t("promo_vide")}</p>
        ) : (
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {promotions.map((promo) => (
              <div key={promo.id} style={{
                display: "flex", alignItems: "center", gap: 10, padding: "10px 12px",
                borderRadius: 10, background: "#FDF8F0", opacity: promo.actif ? 1 : 0.5,
              }}>
