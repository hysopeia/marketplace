  ...
  return (
    <div style={{
      ...
      <div ref={conteneurRef} style={{
        ...
        background: "#FDF8F0", borderRadius: 12, marginBottom: 16,
        minHeight: 300, alignItems: "center",
      }} />

      <p style={{ fontSize: 12, color: "#9CA3AF", marginBottom: 16, wordBreak: "break-all" }}>
        {urlPublique}
      </p>
      ...
      <button
        ...
        style={{
          ...
          background: pret ? "#F59E0B" : "#E5E1D8", color: "white",
